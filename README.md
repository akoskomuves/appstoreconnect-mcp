...
**The roadmap is complete** — every planned surface from v0.1 to v1.0 has shipped. Future work tracks Apple's API changes (new resources, contract drift — see `scripts/audit-fieldsets.py`).
